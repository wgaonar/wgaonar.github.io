...
date:   2017-06-05 14:32:53 -0600
categories: jekyll update
---

<img width="400" src="{{"/assets/Post01/imagenPortada.png" | relative_url}}">

Excelente día para todos!

En este post muestro el circuito, el diagrama de flujo, el código en lenguage 
ensamblador y la implementación de un programa para que el microcontrolador [PIC 16F886](http://ww1.microchip.com/downloads/en/devicedoc/41291f.pdf) 
...
La implementación consta de 3 interruptores de entrada, uno para seleccionar que operación lógica que el usuario desea realizar, y los otros dos serán las entradas de la operación lógica seleccionada. Por otra parte, la salida consta de un led para indicar el resultado de la operación lógica elegida según el estado de las entradas.
...
<center>
  <figure>
    <img src="{{"/assets/Post01/circuit.png" | relative_url}}"
...
<center>
  <figure>
    <img src="{{"/assets/Post01/main.png" | relative_url}}"
...
<center>
  <figure>
    <img src="{{"/assets/Post01/subor.png" | relative_url}}"
...
<center>
  <figure>
    <img src="{{"/assets/Post01/suband.png" | relative_url}}"
...
<center>
  <video height="360" controls poster="{{"/assets/Post01/snapShotVideo.png" | relative_url}}">
  <source src="{{"/assets/Post01/video.mp4" | relative_url}}" type="video/mp4">
  </video>
</center>
